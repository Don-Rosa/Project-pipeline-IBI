...
do
  ...
  then
      ...
      then
       ...
       bwa mem $3 $1'/'$filename  -R '@RG\tID:${array[0]}\tPL:ILLUMINA\tPI:0\tSM:${array[0]}\tLB:1' > $1'/'"${array[0]}".sam
      ...
      then
        ...
        bwa mem $3 $1'/'$filename0 $1'/'$filename1 -R '@RG\tID:${array[0]}\tPL:ILLUMINA\tPI:0\tSM:${array[0]}\tLB:1' > $1'/'"${array[0]}".sam
      fi
      samtools view -bt $3 $1'/'"${array[0]}".sam > $1'/'"${array[0]}".bam
      samtools sort -o $1'/'"${array[0]}"_sorted.bam $1'/'"${array[0]}".bam
      gatk MarkDuplicatesSpark -I $1'/'"${array[0]}"_sorted.bam -O $1'/'"${array[0]}"_gatk.bam -OBI
  fi
done
